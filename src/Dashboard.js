...
import { Router, Route, useRouteMatch, Switch } from 'react-router-dom';
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Switch>
          ...
          <Route path={"/dashboard/deposits"} component={Deposits} />
          <Route path={"/dashboard/coins"} component={Coins} />
        </Switch>
      </main>
    </div>
  );
